...
import {
  ...
  labStationDefinition, labCapReason, infrastructureCapReason,
  usableForLab, availableLabItems, matchingStorageForTypes,
  requirementLabels, infrastructureUnlocked,
  donationDestinationsForItem, futureDonationDestinationsForItem,
...
import {
  ...
  isReservedStorageItem, stableStorageItemsForDisplay, bulkLotForItem
...
import { HostingProjectsPanel } from "./components/HostingProjectsPanel";
import { SavesPanel } from "./components/SavesPanel";
import { DistrictsPanel } from "./components/DistrictsPanel";
import { BuildLabPanel } from "./components/BuildLabPanel";
    ...
    <main className="shell">
      ...
      {donationItem ? (
        <DonationChoiceModal
          game={game}
          item={donationItem}
          destinations={donationDestinationsForItem(game, donationItem)}
          futureDestinations={futureDonationDestinationsForItem(game, donationItem)}
